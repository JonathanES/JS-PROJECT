...
class Favorite extends Component {
    ...
    render() {
        return (
            <div>
                <button onClick={this.handleClick} className={this.state.favorite ? "btn-img btn-delete-favorite uppercase" : "btn-img btn-favorite uppercase"}>Ajouter aux favoris</button>
            </div>
        );
    }
}
